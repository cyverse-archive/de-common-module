...
public class AssertionHelper {
     ...
     * @throws org.iplantc.saml.Saml2Exception is thrown if the assertion attributes cannot be set.
     * @throws org.opensaml.xml.io.MarshallingException is thrown if the assertion cannot be signed.
     */
     ...
     * @throws Saml2Exception is thrown if adding an attribute to the statement fails.
     */
    private static void includeAttributes(HttpServletRequest request, AssertionBuilder builder)
        ...
        for (String attrName : DESecurityConstants.getLocalAttributeNames()) {
            ...
            if (value != null && !value.toString().isEmpty()) {
                ...
                attributeStatementBuilder.addStringAttribute(attrDisplayName, ATTRIBUTE_URL,
                        value.toString());
            }
        }
    }
    ...
    /**
     * Gets the display name for the attribute. For our purposes, the display name is the same as the
     * local attribute name, but with the "shibboleth" prefix removed.
     * 
     ...
     * @throws org.opensaml.xml.io.MarshallingException is thrown if encryption of the assertion fails.
     */
