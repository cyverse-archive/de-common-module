...
public class TestDEServiceDispatcher extends TestCase implements ServletContext {
    public void testNoAddress() throws SerializationException {
    ...
    public void testPutBodyNull() throws SerializationException {
        DEServiceDispatcher dispatcher = new DEServiceDispatcher();
        dispatcher.setContext(this);
    ...
    public void testPutBodyEmpty() throws SerializationException {
        DEServiceDispatcher dispatcher = new DEServiceDispatcher();
        dispatcher.setContext(this);
        ServiceCallWrapper wrapper = new ServiceCallWrapper(ServiceCallWrapper.Type.PUT, "some.address",
                "");
    ...
    public void testPostBodyNull() throws SerializationException {
        DEServiceDispatcher dispatcher = new DEServiceDispatcher();
        dispatcher.setContext(this);
    ...
    public void testPostBodyEmpty() throws SerializationException {
        DEServiceDispatcher dispatcher = new DEServiceDispatcher();
        dispatcher.setContext(this);
        ServiceCallWrapper wrapper = new ServiceCallWrapper(ServiceCallWrapper.Type.POST,
                "some.address", "");
    ...
    public void testDeleteAddressNull() throws SerializationException {
        DEServiceDispatcher dispatcher = new DEServiceDispatcher();
        dispatcher.setContext(this);
    ...
    public void testDeleteAddressEmpty() throws SerializationException {
        DEServiceDispatcher dispatcher = new DEServiceDispatcher();
        dispatcher.setContext(this);
